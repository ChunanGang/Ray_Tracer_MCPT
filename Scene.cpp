...
const float section = 0.1; // the size of the segment cube
const int y_size = 32;// (y_max - y_min) / section;
const int x_size = 120;// (x_max - x_min) / section;
const int z_size = 120;// (z_max - z_min) / section;
...
void initScene(Sphere* cpu_spheres) {
	...
	// lightsource
	cpu_spheres[1].radius = 0.3f;
	cpu_spheres[1].position = Vector3Df(.5f, .2f, -.5f);
	cpu_spheres[1].specular = Vector3Df(0.0f, 0.0f, 0.0f);
	cpu_spheres[1].emission = Vector3Df(4.f, 4.f, 4.f);
	cpu_spheres[1].shininess = 0;

	cpu_spheres[2].radius = 1.0f;
	cpu_spheres[2].position = Vector3Df(-0.0f, 1.8f, -0.0f);
	cpu_spheres[2].specular = Vector3Df(0.0f, 0.0f, 0.0f);
	cpu_spheres[2].emission = Vector3Df(4.9f, 4.02f, 2.16f);
	cpu_spheres[2].shininess = 0;

	// spheres
	cpu_spheres[3].radius = 0.16f;
	cpu_spheres[3].position = Vector3Df(-0.25f, 0.16f, -0.1f);
	cpu_spheres[3].specular = Vector3Df(0.6f, 0.7f, 0.9f);
	cpu_spheres[3].emission = Vector3Df(0.0f, 0.0f, 0.0f);
	cpu_spheres[3].shininess = 100;
	/*
	...
	cpu_spheres[4].radius = .4f;
	cpu_spheres[4].position = Vector3Df(-.5f, 0.2f, .5f);
	cpu_spheres[4].specular = Vector3Df(0.9f, 0.9f, 0.9f);
	cpu_spheres[4].emission = Vector3Df(.0f, .0f, .0f);
